                        ...
                        <div className="col-lg-4 mr_left_minus_240">
                            <div className="image_box_only  type_one  mr_top_minus_10">
                                ...
                                <div className="image one">
                                    <img src="https://themepanthers.com/wp/valuenable/v1/wp-content/uploads/2022/12/choose-1-min.png" width={375} height={490} decoding="async" data-src="https://themepanthers.com/wp/valuenable/v1/wp-content/uploads/2022/12/choose-1-min.png" alt="img" data-ll-status="loaded" className="entered litespeed-loaded" /><noscript>&lt;img width="375" height="490"
                                        decoding="async"
                                        src="https://themepanthers.com/wp/valuenable/v1/wp-content/uploads/2022/12/choose-1-min.png"
                                        alt="img" /&gt;</noscript></div>
                                <div className="image two">
                                    <img src="https://themepanthers.com/wp/valuenable/v1/wp-content/uploads/2022/12/service-8-min.jpg" width={648} height={648} decoding="async" data-src="https://themepanthers.com/wp/valuenable/v1/wp-content/uploads/2022/12/service-8-min.jpg" alt="img" data-ll-status="loaded" className="entered litespeed-loaded" /><noscript>&lt;img width="648" height="648"
                                        decoding="async"
                                        src="https://themepanthers.com/wp/valuenable/v1/wp-content/uploads/2022/12/service-8-min.jpg"
                                        alt="img" /&gt;</noscript></div>
                            </div>
                        </div>
                    </div>
