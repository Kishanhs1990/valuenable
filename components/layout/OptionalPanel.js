                    ...
                    <div className="option_content scrollbarcolor ">
                        <div className="log_bx">
                            <Link href="#" className="logo navbar-brand">
                                {/* <img src="/assets/images/theme-logo.png" alt="valuenable" className="logo_default" /> */}
                        ...
                        <div className="contnet_box">
                            ...
                            <div className="contact_panel">
                                <div className="c_pan">
                                    <Link href="tel:9999999999">
                                        <i className="fi-rr-phone-call" /> 9999999999 </Link>
                                </div>
                                <div className="c_pan">
                            ...
                            <div className="c_pan"> © {new Date().getFullYear()} valuenable. All Rights Reserved. </div>
                        </div>
                    </div>
                </div>
            </div>
