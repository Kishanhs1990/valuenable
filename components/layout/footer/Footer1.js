                    ...
                    <div className="call_to_action style_one">
                        ...
                        <div className="d-flex align-items-center contact_header_one">
                            ...
                            <div className="content">
                                ...
                                <div className="title_20"><Link href="tel:(+91)9999999999">(+91) 9999999999</Link></div>
                            </div>
                        </div>
                    </div>
                    {/*-============spacing==========-*/}
                                ...
                                <div className="footer_widgets_box pd_bottom_30">
                                    <div className="logo_box">
                                        <Link href="#" className="logo navbar-brand">
                                            {/* <img src="/assets/images/footer-logo-blue.png" alt="valuenable" className="logo_default" /> */}
                                            <p style={{ color: 'red' }}>LOGO IPSUM</p>
                                        </Link>
                                    </div>
                                    {/*-============spacing==========-*/}
                                    ...
                                    <ul className="list_box linline">
                                        <li>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <Link className="links color_white" href="#">
                                                    Copyright {new Date().getFullYear()}, valuenable. All Rights Reserved
                                                </Link>
                                            </div>
                                        </li>
                                    </ul>
