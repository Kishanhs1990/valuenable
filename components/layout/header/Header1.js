                                ...
                                <div className="col-xl-2 col-lg-12 col-md-5 col-sm-5 col-xs-5">
                                    <div className="logo_box">
                                        ...
                                        <Link href="/" className="logo navbar-brand">
                                            {/* <img src="/assets/images/logo-white.svg" alt="valuenable" className="logo_default" /> */}
                                            <p style={{ color: 'white' }}>LOGO IPSUM</p>
                                        </Link>
                                        {/*logo*/}
                                    </div>
                                </div>
